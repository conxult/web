...
class MethodBuilder {
    ...
    void addParameter(VariableElement parameter) {
        ...
        var principalParam = parameter.getAnnotation(WebRpcPrincipalParam.class);
        ...
        } else if (principalParam != null) {
            parameters.add(new Parameter(principalParam, parameterType, parameterName));
        } else {
